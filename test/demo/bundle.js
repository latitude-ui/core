...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        return React.createElement("button", { onClick: this.props.onClick }, this.props.label);
    };
    return Button;
}(React.Component));
...
reactDom.exports.render( /*#__PURE__*/React.createElement(App, null), document.querySelector("#root"));
